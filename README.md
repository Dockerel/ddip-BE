...
### 성과
* 기존 전체 집계 성능 대비 속도 98% 증가 (유저 지점 수 10,000건으로 테스팅, 105,788,709ns &rarr; 1,262,875ns)
* 유저 위치가 10배로 증가해도, 기존 전체 집계 성능 대비 속도 97% 증가 (유저 지점 수 100,000건으로 테스팅, 105,788,709ns &rarr; 2,256,458ns)
